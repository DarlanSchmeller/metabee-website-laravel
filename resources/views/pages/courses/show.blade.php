                ...
                <div class="grid lg:grid-cols-3 gap-12">
                    ...
                    <div class="lg:col-span-2">
                        ...
                        <div
                            ...
                            <p class="text-content leading-relaxed mb-6">{{ $course['fullDescription'] }}</p>
                                    ...
                                    <div
                                        ...
                                        <div class="flex items-center space-x-4">
                                            <div
                                                ...
                                                <span
                                                    class="text-amber-500 font-semibold">{{ $loop->iteration }}</span>
                                            </div>
                                            <div>
                                                <h3 class="text-white font-semibold">{{ $module->module }}</h3>
                        ...
                        <div class="sticky top-32">
                            <div
                                ...
                                <div class="border-t border-amber-500/20 pt-6 mt-6 text-content text-sm">
                                    Última atualização: 
                                    <span class="text-white font-medium">{{ $course['updated_at']->translatedFormat('d F Y') }}</span>
                                </div>
                            </div>
                        </div>
                    </div>
