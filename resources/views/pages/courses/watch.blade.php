        ...
        <div class="max-w-7xl mx-auto px-6 mb-10">
            <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                ...
                <div class="flex items-center gap-3">
                    ...
                    <span class="text-amber-400 text-sm font-semibold">60%</span>
                </div>
            </div>
        </div>
                ...
                >
                    <div class="flex items-start justify-between gap-4 mb-4">
                        ...
                        <div class="flex gap-2">
                            <button
                                class="bg-gray-800/50 border border-green-500/30 text-green-400 px-3 py-2 rounded-md hover:bg-green-500/10 flex items-center gap-2 text-sm"
                            >
                            ...
                            <div class="p-4">
                                ...
                                <ul class="space-y-1.5">
                                    @foreach ($module->lessons as $lesson)
                                        <li>
                                            <a
                                                href="{{ route("course.watch", [$course->id, $module->id, $lesson->id]) }}"
                                            >
                                                <button
                                                    class="w-full text-left px-3 py-2 rounded-md hover:bg-gray-800/50 flex items-start gap-3"
                                                >
                                                    <div
