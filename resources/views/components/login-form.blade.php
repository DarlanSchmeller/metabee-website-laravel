                ...
                <form method="POST" action="{{ route('login') }}" class="space-y-5 md:space-y-6">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input id="email" type="email" name="email" required autofocus placeholder="seu@email.com"
                                   class="pl-10 bg-zinc-800/50 border border-zinc-700 text-white placeholder:text-gray-300 focus:border-amber-500 focus:ring-amber-500/20 focus:ring-1 rounded-lg w-full py-3 text-base md:text-lg transition" />
                        </div>
                    </div>
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            ...
                            <input id="password" type="password" name="password" required placeholder="••••••••"
                                   class="pl-10 pr-10 bg-zinc-800/50 border border-zinc-700 text-white placeholder:text-gray-300 focus:border-amber-500 focus:ring-amber-500/20 focus:ring-1 rounded-lg w-full py-3 text-base md:text-lg transition" />
                        </div>
                    </div>
                    ...
                    <div class="mt-4 text-center text-sm text-gray-300">
                        ...
                        <a href="#" class="text-amber-400 hover:text-amber-300 font-medium">Crie agora</a>
                    </div>
                </form>
            </div>
