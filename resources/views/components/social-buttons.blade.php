{{-- LinkedIn --}}
<a href="{{ $linkedinLink }}" target="_blank" class="text-gray-400 hover:text-amber-500 transition-colors">
...
{{-- Instagram --}}
<a href="{{ $instagramLink }}" target="_blank" class="text-gray-400 hover:text-amber-500 transition-colors">
    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        <path
...
{{-- Facebook --}}
<a href="{{ $facebookLink }}" target="_blank" class="text-gray-400 hover:text-amber-500 transition-colors">
    <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
        <path
