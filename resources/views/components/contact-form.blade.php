                            ...
                            <div class="relative">
                                ...
                                >
                                    <path
                                        ...
                                        stroke-linejoin="round"
                                        stroke-width="2"
                                        d="M5.121 17.804A12.042 12.042 0 0112 15c2.691 0 5.154.902 7.121 2.804M15 11a3 3 0 11-6 0 3 3 0 016 0z"
                                    />
                                </svg>
                                <input
                                    type="text"
                        ...
                        <div class="relative">
                            ...
                            >
                                <path
                                    ...
                                    stroke-linejoin="round"
                                    stroke-width="2"
                                    d="M8 10h.01M12 10h.01M16 10h.01M21 12c0 4.418-4.03 8-9 8-1.764 0-3.415-.507-4.793-1.374L3 20l1.374-4.207A8.963 8.963 0 013 12c0-4.418 4.03-8 9-8s9 3.582 9 8z"
                                />
                            </svg>
                            <textarea
                                name="message"
...
{{ old("message") }}</textarea
            ...
            @else
                ...
                <div class="py-12 text-center">
                    ...
                    <p class="text-gray-400">Obrigado por entrar em contato. Retornaremos em até 24 horas.</p>
                </div>
            @endif
