    ...
    <div class="max-w-7xl mx-auto px-4 py-2 sm:px-6 lg:px-8">
        <div class="flex justify-between items-center h-16">
            ...
            <a href="{{ route('home') }}" class="flex items-center space-x-2">
                <x-logo />
                <span class="text-2xl font-bold bg-gradient-to-r from-amber-400 to-yellow-500 bg-clip-text text-transparent">
                    MetaBee
                </span>
            </a>
            ...
            @auth
                <div class="hidden md:flex items-center space-x-8">
                    ...
                    <div class="flex items-center gap-2 text-gray-200">
                        {{-- Generic Avatar Icon --}}
                        <div class="w-10 h-10 rounded-full bg-amber-500/20 border border-amber-500/40 flex items-center justify-center">
                ...
                @auth
                    <div class="pt-4 border-t border-amber-500/20 mt-2 space-y-3">
                        ...
                        <div class="flex items-center gap-3 text-gray-200">
                            <div class="w-9 h-9 rounded-full bg-amber-500/20 border border-amber-500/40 flex items-center justify-center">
