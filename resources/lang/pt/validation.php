...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | As mensagens de validação padrão usadas pelo Laravel. Você pode
    | personalizar cada mensagem de acordo com os atributos do seu projeto.
    |
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Atributos customizados para exibir nomes amigáveis nos erros.
    |
    */
